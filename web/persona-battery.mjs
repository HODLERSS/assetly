...
level: vocabulary and explanation depth match the reader's level (novice: no bare acronyms or unexplained jargon, hard terms briefly explained, plain words; pro: professional register, no dumbing down). Ticker symbols and their weights (like QQQM 25.6%) are NAMES, not jargon, and are fine at every level. To FAIL quote a mismatch; else pass.

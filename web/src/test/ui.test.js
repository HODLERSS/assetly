...
vi.mock("../lib/supabase", () => {
    ...
    return {
        ...
        signInWithOAuth: (p) => oauthSpy(p),
        signInWithEmail: (e) => emailSpy(e),
    };
});
import { App } from "../App";
import { AuthScreen } from "../screens/Auth";
const profile = { id: "u-test", display_name: "Minjae", base_currency: "USD", markets: ["US", "KR"], onboarded_at: "2026-08-23T00:00:00Z" };
const row = (over) => ({
...
describe("U7 news", () => {
    it("lists stories and filters by holding chip", async () => {
        ...
        await userEvent.click(screen.getByRole("group", { name: /filter news/i }).querySelectorAll("button")[1]);
